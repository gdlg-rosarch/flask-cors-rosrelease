## flask_cors (kinetic) - 3.0.3-2

The packages in the `flask_cors` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic flask_cors` on `Fri, 13 Apr 2018 13:37:25 -0000`
